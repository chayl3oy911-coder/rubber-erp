...
import { MovementTypeBadge } from "@/app/(app)/stock/_components/movement-type-badge";
...
/**
 * Renders the StockMovement rows tied to a single SalesOrder. We reuse the
 * Stock module's MovementTypeBadge — the badge is a pure visual mapping
 * over StockMovementType, so coupling is intentional.
 */
export function SalesMovementList({ movements }: Props) {
